...
for item in rap_song_results['tracks']['items']:
    rap_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images': item['album']['images'][0]['url']})
...
for item in trap_song_results['tracks']['items']:
    trap_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images':item['album']['images'][0]['url']})
    
    
indie_song_results = sp.search(q='genre:' + "indie", type='track', limit = 10)
indie_song_list = []
for item in indie_song_results['tracks']['items']:
    indie_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images": item['album']['images'][0]['url']})
    
    
folk_song_results = sp.search(q='genre:' + "folk", type='track', limit = 10)
folk_song_list = []
for item in indie_song_results['tracks']['items']:
    folk_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images":item['album']['images'][0]['url']})
...
for item in alternative_song_results['tracks']['items']:
    alternative_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'],'images':item['album']['images'][0]['url']})
    

rock_song_results = sp.search(q='genre:' + 'rock', type='track', limit = 10)
rock_song_list = []
for item in rock_song_results['tracks']['items']:
    rock_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'], 'images':item['album']['images'][0]['url']})
        
    
classical_song_results = sp.search(q='genre:' + 'classical', type='track', limit = 10)
classical_song_list = []
for item in classical_song_results['tracks']['items']:
    classical_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'], 'images':item['album']['images'][0]['url']})
