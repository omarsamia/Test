...
for item in rap_song_results['tracks']['items']:
    rap_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images':item[0]['images'][0]['url']})
...
for item in pop_song_results['tracks']['items']:
    pop_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
        
randb_song_results=sp.search(q='genre:' + "randb", type='track', limit=10)
randb_song_list=[]
for item in randb_song_results['tracks']['items']:
    randb_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
    
    
trap_song_results=sp.search(q='genre:' + "trap", type='track', limit=10)
trap_song_list=[]
for item in trap_song_results['tracks']['items']:
    trap_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'], 'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
    
    
indie_song_results = sp.search(q='genre:' + "indie", type='track', limit = 10)
indie_song_list = []
for item in indie_song_results['tracks']['items']:
    indie_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images": item[0]['album']['images']['url']})
    
    
folk_song_results = sp.search(q='genre:' + "folk", type='track', limit = 10)
folk_song_list = []
for item in indie_song_results['tracks']['items']:
    folk_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images":item[0]['album']['images']['url']})
    
country_song_results = sp.search(q='genre:' + "country", type='track', limit = 10)
country_song_list = []
for item in country_song_results['tracks']['items']:
    country_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images": item[0]['album']['images']['url']})
...
for item in electrical_song_results['tracks']['items']:
    electrical_song_list.append({'name': item['name'], "artists": item['artists'][0]['name'], "Link": item['external_urls']['spotify'], "images":item[0]['album']['images']['url']})
...
for item in alternative_song_results['tracks']['items']:
    alternative_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'],'images':item[0]['album']['images']['url']})
    

rock_song_results = sp.search(q='genre:' + 'rock', type='track', limit = 10)
rock_song_list = []
for item in rock_song_results['tracks']['items']:
    rock_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
        
    
classical_song_results = sp.search(q='genre:' + 'classical', type='track', limit = 10)
classical_song_list = []
for item in classical_song_results['tracks']['items']:
    classical_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
    

soul_song_results = sp.search(q='genre:' + 'soul', type='track', limit = 10)
soul_song_list = []
for item in soul_song_results['tracks']['items']:
    soul_song_list.append({'name':item['name'], 'artists':item['artists'][0]['name'],'link':item['external_urls']['spotify'], 'images':item[0]['album']['images']['url']})
